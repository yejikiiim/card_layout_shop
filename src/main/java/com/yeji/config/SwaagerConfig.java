    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
               ...
               //.apis(Predicates.not(RequestHandlerSelectors.basePackage("org.springframework.boot"))) // org.springframework.boot 패키지 제외
                .apis(RequestHandlerSelectors.basePackage("com.iparking.api"))// com.iparking.api 패키지에 해당되는 컨트롤러만
               //.apis(Predicates.or(
               //        RequestHandlerSelectors.basePackage("com.iparking.api.contoller"),
               //        RequestHandlerSelectors.basePackage("com.iparking.common")
               //        RequestHandlerSelectors.basePackage("com.iparking.component.excel.tutorial")
               //        )
               //    ) // 특정 패키지들의 컨트롤러만
               ...
               //.paths(PathSelectors.ant("/imis/v2/**/*")) //특정 정규식 패턴에 해당되는 API 추가
                .build()
                /** Swagger 3.0.0 SNAPSHOT 전용 설정 2.9.2 사용시 주석처리 */
