...
import com.yeji.common.annotation.ParamName;
...
public class ParamNameProcessor extends ServletModelAttributeMethodProcessor {
    ...
    private static final Map<Class<?>, Map<String, String>> PARAM_MAPPINGS_CACHE = new ConcurrentHashMap<>();
