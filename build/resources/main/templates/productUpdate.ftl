                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <input type="text" id="productName" class="form-control" value="${result.result.productName}">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <input type="text" id="productGroupCode" class="form-control" placeholder="대문자 7자리" value="${result.result.groupCode}" disabled>
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <input type="text" id="price" class="form-control" value="${result.result.price}">
                        ...
                        <div class="card-body">
                            ...
                            <div id="optionView">
                                <#list result.result.productDetailList as data>
                                    <div>
                                        <div style="float: left;"><input type="text" class="form-control"  name="productOption" placeholder="옵션입력" value="${data.productDetailOption}"></div>
                                        <div style="float: left; margin-right: 300px;"><input type="text" class="form-control"  name="productStock" placeholder="재고입력" value="${data.stock}"></div>
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <input type="text" id="description" class="form-control" value="${result.result.description}">
...
<script type="text/javascript">
    ...
    function setOption() {
        ...
        "<div style=\"float: left; margin-right: 100px;\"><input type=\"text\" class=\"form-control\"  name=\"productStock\" placeholder=\"재고입력\"></div></div>";
    ...
    sendButton.addEventListener("click",function(){
        ...
        var optionIdSize = $("input[name='productId']").length;

        var optionId = new Array(optionIdSize);
        ...
        for(var i=0; i<optionIdSize; i++){
            optionId[i] = $("input[name='productId']")[i].value;
        }
        ...
        $.ajax({
            url:"/product/update/${result.result.groupCode}", // 요청 할 주소
